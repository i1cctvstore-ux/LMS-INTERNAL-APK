...
create policy "project_technicians_select_authenticated"
...
create policy "project_technicians_all_authenticated"
...
create policy "project_logs_insert_authenticated"
...
-- role authenticated sesuai kebutuhan. Langkahnya ada di README.md.
