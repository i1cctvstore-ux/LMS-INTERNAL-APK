...
-- ---------------------------------------------------------------------------
-- is_super_admin() TIDAK didefinisikan ulang di sini — project ini sudah
-- punya function itu (dibuat di migration 20260713000000_add_branches.sql),
-- dan versinya SUDAH BENAR (ikut mengecek `active = true`, jadi karyawan
-- yang dinonaktifkan otomatis kehilangan akses super_admin). Policy di
-- bawah langsung pakai public.is_super_admin() yang sudah ada itu.
-- ---------------------------------------------------------------------------
