  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <div className="border-b border-slate-200 bg-white sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-4 flex flex-wrap items-center justify-between gap-x-3 gap-y-1">
          <h1 className="font-semibold text-lg text-slate-800">Klaim Servis &amp; Garansi</h1>
